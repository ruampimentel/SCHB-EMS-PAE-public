...
CD 'C:\Users\ruamp\OneDrive - University of Toledo\Conferences\SPA 2020\Depressive Indicators\ICC - second round'.

GET DATA
  /TYPE=XLSX
  /FILE='Kline Protocols R-ID - Fifth 20 GM RP AZ.xlsx'
  /SHEET=name 'Sheet1'
  /CELLRANGE=FULL
  /READNAMES=ON
...
RELIABILITY
  /VARIABLES=SCHB_GM SCHB_AZ SCHB_RP 
  /SCALE('SCHB') ALL
  /MODEL=ALPHA
...
RELIABILITY
  /VARIABLES=EMS_GM EMS_AZ EMS_RP
  /SCALE('EMS') ALL
  /MODEL=ALPHA
  /STATISTICS=DESCRIPTIVE CORR
  /SUMMARY=MEANS CORR
...
RELIABILITY
  /VARIABLES=PAE_GM PAE_AZ PAE_RP 
  /SCALE('PAE') ALL
  /MODEL=ALPHA
  /STATISTICS=DESCRIPTIVE CORR
  /SUMMARY=MEANS CORR
...
OUTPUT SAVE NAME=Document1 OUTFILE=
 'Interrater Reliability Results - Second 20.spv'
  LOCK=NO.

OUTPUT EXPORT  /CONTENTS  EXPORT=ALL  LAYERS=PRINTSETTING  MODELVIEWS=PRINTSETTING  /XLSX  DOCUMENTFILE=
 'Interrater Reliability Results - Second 20.xlsx'
  OPERATION=CREATEFILE
  LOCATION=LASTCOLUMN  NOTESCAPTIONS=YES.

SAVE OUTFILE=
 'Interrater Reliability - Second 20 PL.sav'
 /COMPRESSED.

SAVE TRANSLATE OUTFILE=
 'Interrater Reliability - Second 20 PL.xlsx'
